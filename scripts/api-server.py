...
class H(http.server.BaseHTTPRequestHandler):
  ...
  def do_GET(self):
    if self.path=='/status':
      ...
      for lf in ['/var/log/bootstrap.log','/var/log/phase1.log','/var/log/phase2.log','/var/log/post-boot-check.log','/var/log/gateway-health-check.log','/var/log/safe-mode-recovery.log','/var/log/cloud-init-output.log']:
        try:
          self.wfile.write(f"\n=== {lf} ===\n".encode())
