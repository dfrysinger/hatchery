...
Ready-to-use habitat configuration templates using the v2 schema.
...
These templates use the **v2 schema**:
- Platform config: `platforms.discord` / `platforms.telegram`
- Agent tokens: `agents[].tokens.discord` / `agents[].tokens.telegram`

See [issue #112](https://github.com/dfrysinger/hatchery/issues/112) for v1 deprecation info.
